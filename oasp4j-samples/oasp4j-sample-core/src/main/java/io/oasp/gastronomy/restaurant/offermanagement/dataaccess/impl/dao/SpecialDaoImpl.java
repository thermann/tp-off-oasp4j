...
public class SpecialDaoImpl extends ApplicationDaoImpl<SpecialEntity> implements SpecialDao {
  ...
  public PaginatedListTo<SpecialEntity> findSpecials(SpecialSearchCriteriaTo criteria) {
    ...
    WeeklyPeriodSearchCriteriaTo wpsc = criteria.getActivePeriod();

    WeeklyPeriodEmbeddable activePeriod = new WeeklyPeriodEmbeddable();
    activePeriod.setEndingDay(wpsc.getEndingDay());
    activePeriod.setEndingHour(wpsc.getEndingHour());
    activePeriod.setStartingDay(wpsc.getStartingDay());
    activePeriod.setStartingHour(wpsc.getStartingHour());
